                        ...
                        children: [
                          Row(
                            children: <Widget>[
                              ...
                              Container(
                                child: const Icon(Icons.remove_red_eye_outlined, size: 10, color: Colors.grey,)
                              ),
                              const SizedBox(width: 3),
                              Container(
                                child: Text(chatData['date'], maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 11, color: Colors.grey))
                              )
                            ],
                          ),
